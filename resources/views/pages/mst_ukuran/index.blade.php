        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-lg-10">
                    <div class="form-group">
                        <div class="form-group-feedback form-group-feedback-left">
                            <input name="Keyword" type="text" class="form-control form-control search-keyword" aria-label="Small" onchange="_page._event.search();" placeholder="Search ukuran">
                ...
                <div class="col-lg-2 text-right">
                    <div class="form-group">
                        <button type="button" class="btn btn-warning  mr-1" id="btn-search" data-size="small" onclick="_page._event.search();" ><i class="{{config('global.icon.search')}} mr-1"></i>Search</button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="ModalFormAction" action="">
                ...
                <input type="hidden" class="kode_ukuran" name="kode_ukuran" value="">
                <input type="hidden" class="v_ukuran_old" name="v_ukuran_old" value="">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="col-form-label font-weight-semibold">Name<span class="text-danger ml-1">*</span></label>
                        <input type="text" class="form-control form-control v_ukuran" placeholder="Ukuran Name" name="v_ukuran" value="" required>
                    </div>
...
@section('plugin')
<script src="{{ asset('js/pages/ukuran.js')}}"></script>
@endsection
