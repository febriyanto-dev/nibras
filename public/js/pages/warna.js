...
$(document).ready(function () {
    ...
    general.module = 'master_warna';
    general.url = route('warna_action');
                        ...
                        _page._getData(id, function(response){
                            ...
                            if (response.respon == 'success') {
                                ...
                                $('#modal-form').on('shown.bs.modal', function () {
                                    ...
                                    $('.modal-title').html('EDIT WARNA');
                                    $('.module').val(general.module);
                                    $('.act').val('edit');
                                    $('.v_warna').focus();

                                    $('.kode_warna').val(id);
                                    $('.v_warna').val(response.data.nama_warna);
                                    $('.v_warna_old').val(response.data.nama_warna);
                                });
                            }
